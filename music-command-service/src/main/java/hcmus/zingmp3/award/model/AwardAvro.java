...
public class AwardAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2561191629866283632L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AwardAvro\",\"namespace\":\"hcmus.zingmp3.award.model\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"}]}");
   ...
   */
  public AwardAvro(java.lang.CharSequence id, java.lang.CharSequence name) {
    this.id = id;
    this.name = name;
  }
   ...
   */
  public static hcmus.zingmp3.award.model.AwardAvro.Builder newBuilder() {
    return new hcmus.zingmp3.award.model.AwardAvro.Builder();
  }
   ...
   * @return A new AwardAvro RecordBuilder
   */
  public static hcmus.zingmp3.award.model.AwardAvro.Builder newBuilder(hcmus.zingmp3.award.model.AwardAvro.Builder other) {
    return new hcmus.zingmp3.award.model.AwardAvro.Builder(other);
  }
   ...
   * @return A new AwardAvro RecordBuilder
   */
  public static hcmus.zingmp3.award.model.AwardAvro.Builder newBuilder(hcmus.zingmp3.award.model.AwardAvro other) {
    return new hcmus.zingmp3.award.model.AwardAvro.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AwardAvro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(hcmus.zingmp3.award.model.AwardAvro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(hcmus.zingmp3.award.model.AwardAvro other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public hcmus.zingmp3.award.model.AwardAvro.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public hcmus.zingmp3.award.model.AwardAvro.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public hcmus.zingmp3.award.model.AwardAvro.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public hcmus.zingmp3.award.model.AwardAvro.Builder clearName() {
      name = null;
