...
public class ArtistAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3811370040778736949L;
  ...
  @Deprecated public CharSequence alias;
  @Deprecated public CharSequence playlistId;
  @Deprecated public CharSequence thumbnail;
  @Deprecated public int totalFollow;
  @Deprecated public CharSequence sortBiography;
  @Deprecated public CharSequence biography;
  @Deprecated public CharSequence national;
  @Deprecated public CharSequence realName;
  @Deprecated public CharSequence birthday;
  @Deprecated public java.util.List<CharSequence> awards;
  @Deprecated public java.util.List<CharSequence> songs;
   ...
   */
  public ArtistAvro(CharSequence id, CharSequence name, CharSequence alias, CharSequence playlistId, CharSequence thumbnail, Integer totalFollow, CharSequence sortBiography, CharSequence biography, CharSequence national, CharSequence realName, CharSequence birthday, java.util.List<CharSequence> awards, java.util.List<CharSequence> songs) {
    this.id = id;
    this.name = name;
    this.alias = alias;
  ...
  public void put(int field$, Object value$) {
    ...
    case 2: alias = (CharSequence)value$; break;
    case 3: playlistId = (CharSequence)value$; break;
    case 4: thumbnail = (CharSequence)value$; break;
    case 5: totalFollow = (Integer)value$; break;
    case 6: sortBiography = (CharSequence)value$; break;
    case 7: biography = (CharSequence)value$; break;
    case 8: national = (CharSequence)value$; break;
    case 9: realName = (CharSequence)value$; break;
    case 10: birthday = (CharSequence)value$; break;
    case 11: awards = (java.util.List<CharSequence>)value$; break;
    case 12: songs = (java.util.List<CharSequence>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public CharSequence getPlaylistId() {
    return playlistId;
  }
   ...
   * @param value the value to set.
   */
  public void setPlaylistId(CharSequence value) {
   ...
   */
  public CharSequence getThumbnail() {
    return thumbnail;
  }
   ...
   * @param value the value to set.
   */
  public void setThumbnail(CharSequence value) {
   ...
   * @param value the value to set.
   */
  public void setTotalFollow(Integer value) {
   ...
   */
  public CharSequence getSortBiography() {
   ...
   * @param value the value to set.
   */
  public void setSortBiography(CharSequence value) {
   ...
   */
  public CharSequence getNational() {
    return national;
  }
   ...
   * @param value the value to set.
   */
  public void setNational(CharSequence value) {
    this.national = value;
  }
   ...
   * @param value the value to set.
   */
  public void setRealName(CharSequence value) {
    this.realName = value;
  }
   ...
   * @param value the value to set.
   */
  public void setBirthday(CharSequence value) {
    this.birthday = value;
  }
   ...
   */
  public java.util.List<CharSequence> getAwards() {
    return awards;
  }
   ...
   * @param value the value to set.
   */
  public void setAwards(java.util.List<CharSequence> value) {
    this.awards = value;
  }
   ...
   */
  public java.util.List<CharSequence> getSongs() {
    return songs;
  }
   ...
   * @param value the value to set.
   */
  public void setSongs(java.util.List<CharSequence> value) {
    this.songs = value;
  }
   ...
   * @return A new ArtistAvro RecordBuilder
   */
  public static Builder newBuilder(ArtistAvro other) {
    return new Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ArtistAvro>
    ...
    private CharSequence playlistId;
    private CharSequence thumbnail;
    private int totalFollow;
    private CharSequence sortBiography;
    private CharSequence biography;
    private CharSequence national;
    private CharSequence realName;
    private CharSequence birthday;
    private java.util.List<CharSequence> awards;
    private java.util.List<CharSequence> songs;
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ArtistAvro other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setAlias(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setPlaylistId(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setThumbnail(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setSortBiography(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setBiography(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setNational(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setRealName(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setBirthday(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setAwards(java.util.List<CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setSongs(java.util.List<CharSequence> value) {
    ...
    public ArtistAvro build() {
      try {
        ...
        record.alias = fieldSetFlags()[2] ? this.alias : (CharSequence) defaultValue(fields()[2]);
        record.playlistId = fieldSetFlags()[3] ? this.playlistId : (CharSequence) defaultValue(fields()[3]);
        record.thumbnail = fieldSetFlags()[4] ? this.thumbnail : (CharSequence) defaultValue(fields()[4]);
        record.totalFollow = fieldSetFlags()[5] ? this.totalFollow : (Integer) defaultValue(fields()[5]);
        record.sortBiography = fieldSetFlags()[6] ? this.sortBiography : (CharSequence) defaultValue(fields()[6]);
        record.biography = fieldSetFlags()[7] ? this.biography : (CharSequence) defaultValue(fields()[7]);
        record.national = fieldSetFlags()[8] ? this.national : (CharSequence) defaultValue(fields()[8]);
        record.realName = fieldSetFlags()[9] ? this.realName : (CharSequence) defaultValue(fields()[9]);
        record.birthday = fieldSetFlags()[10] ? this.birthday : (CharSequence) defaultValue(fields()[10]);
        record.awards = fieldSetFlags()[11] ? this.awards : (java.util.List<CharSequence>) defaultValue(fields()[11]);
        record.songs = fieldSetFlags()[12] ? this.songs : (java.util.List<CharSequence>) defaultValue(fields()[12]);
        return record;
      } catch (Exception e) {
