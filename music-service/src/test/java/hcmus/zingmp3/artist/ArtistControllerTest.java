...
class ArtistControllerTest {
    ...
    public void ArtistController_CreateArtist_ReturnCreated() throws Exception {
        ArtistRequest artistRequest = ArtistDataForTest.ARTIST_REQUESTS.getFirst();
        ArtistResponse artistResponse = ArtistDataForTest.ARTIST_RESPONSES.getFirst();
...
//        when(artistService.createArtist(artistRequest)).thenReturn(artistResponse);
    ...
    public void ArtistController_GetAllArtists_ReturnOk() throws Exception {
        List<ArtistResponse> artistResponseList = ArtistDataForTest.ARTIST_RESPONSES;
    ...
    public void ArtistController_GetArtistById_ReturnOk() throws Exception {
        UUID id = ArtistDataForTest.ARTIST_IDS.getFirst();
        ArtistResponse artistResponse = ArtistDataForTest.ARTIST_RESPONSES.getFirst();
    ...
    public void ArtistController_UpdateArtist_ReturnOk() throws Exception {
        UUID id = ArtistDataForTest.ARTIST_IDS.getFirst();
        ArtistRequest artistRequest = ArtistDataForTest.ARTIST_REQUESTS.get(1);
        ArtistResponse artistResponse = ArtistDataForTest.ARTIST_RESPONSES.get(1);
