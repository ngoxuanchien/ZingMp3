...
class GenreServiceTest {
    ...
    void GenreService_CreateGenre_ReturnGenreResponse() {
        GenreRequest genreRequest = GenreDataForTest.GENRE_REQUESTS.getFirst();
        Genre genreBeforeSave = GenreDataForTest.GENRE_BEFORE_SAVE.getFirst();
        Genre genreAfterSave = GenreDataForTest.GENRE_AFTER_SAVE.getFirst();
        GenreResponse genreResponse = GenreDataForTest.GENRE_RESPONSES.getFirst();
    ...
    void GenreService_GetAllGenres_ReturnGenreResponseList() {
        ...
        List<Genre> genres = GenreDataForTest.GENRE_AFTER_SAVE;
        Page<Genre> genrePage = new PageImpl<>(genres, pageable, genres.size());
        List<GenreResponse> genreResponses = GenreDataForTest.GENRE_RESPONSES;
    ...
    void GenreService_UpdateGenre_ReturnGenreResponse() {
        UUID id = GenreDataForTest.GENRE_IDS.getFirst();
        GenreRequest genreRequest = GenreDataForTest.GENRE_REQUESTS.getFirst();
        Genre genreBeforeSave = GenreDataForTest.GENRE_BEFORE_SAVE.getFirst();
        Genre genreAfterSave = GenreDataForTest.GENRE_AFTER_SAVE.getFirst();
        GenreResponse genreResponse = GenreDataForTest.GENRE_RESPONSES.getFirst();
