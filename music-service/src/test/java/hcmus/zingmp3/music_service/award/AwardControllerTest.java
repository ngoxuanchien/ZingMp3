...
import static hcmus.zingmp3.music_service.award.AwardDataForTest.AWARD_REQUESTS;
import static hcmus.zingmp3.music_service.award.AwardDataForTest.AWARD_RESPONSES;
...
class AwardControllerTest {
    ...
    public void AwardController_GetAwardById_ReturnOk() throws Exception {
        UUID id = AWARD_RESPONSES.getFirst().getId();
        AwardResponse awardResponse = AWARD_RESPONSES.getFirst();
    ...
    public void AwardController_GetAllAwards_ReturnOk() throws Exception {
        List<AwardResponse> awardResponses = AWARD_RESPONSES;
