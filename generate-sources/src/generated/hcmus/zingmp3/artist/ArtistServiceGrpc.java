...
public final class ArtistServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<hcmus.zingmp3.artist.ArtistGrpcRequest,
      hcmus.zingmp3.artist.ArtistGrpcResponse> getExistsArtistMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "existsArtist",
  ...
  public static io.grpc.MethodDescriptor<hcmus.zingmp3.artist.ArtistGrpcRequest,
      hcmus.zingmp3.artist.ArtistGrpcResponse> getExistsArtistMethod() {
    io.grpc.MethodDescriptor<hcmus.zingmp3.artist.ArtistGrpcRequest, hcmus.zingmp3.artist.ArtistGrpcResponse> getExistsArtistMethod;
    if ((getExistsArtistMethod = ArtistServiceGrpc.getExistsArtistMethod) == null) {
      synchronized (ArtistServiceGrpc.class) {
        if ((getExistsArtistMethod = ArtistServiceGrpc.getExistsArtistMethod) == null) {
          ArtistServiceGrpc.getExistsArtistMethod = getExistsArtistMethod =
              ...
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "existsArtist"))
              ...
              .setSchemaDescriptor(new ArtistServiceMethodDescriptorSupplier("existsArtist"))
              .build();
        }
      }
    }
    return getExistsArtistMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void existsArtist(hcmus.zingmp3.artist.ArtistGrpcRequest request,
        io.grpc.stub.StreamObserver<hcmus.zingmp3.artist.ArtistGrpcResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getExistsArtistMethod(), responseObserver);
    }
  ...
  public static final class ArtistServiceStub
    ...
    /**
     */
    public void existsArtist(hcmus.zingmp3.artist.ArtistGrpcRequest request,
        io.grpc.stub.StreamObserver<hcmus.zingmp3.artist.ArtistGrpcResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getExistsArtistMethod(), getCallOptions()), request, responseObserver);
    }
  ...
  public static final class ArtistServiceBlockingStub
    ...
    /**
     */
    public hcmus.zingmp3.artist.ArtistGrpcResponse existsArtist(hcmus.zingmp3.artist.ArtistGrpcRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getExistsArtistMethod(), getCallOptions(), request);
    }
  ...
  public static final class ArtistServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<hcmus.zingmp3.artist.ArtistGrpcResponse> existsArtist(
        hcmus.zingmp3.artist.ArtistGrpcRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getExistsArtistMethod(), getCallOptions()), request);
    }
  ...
  private static final int METHODID_EXISTS_ARTIST = 0;
  private static final int METHODID_GET_ARTIST_BY_ID = 1;
  private static final int METHODID_GET_OR_CREATE_ARTIST = 2;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_EXISTS_ARTIST:
          serviceImpl.existsArtist((hcmus.zingmp3.artist.ArtistGrpcRequest) request,
              (io.grpc.stub.StreamObserver<hcmus.zingmp3.artist.ArtistGrpcResponse>) responseObserver);
          break;
      ...
      synchronized (ArtistServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getExistsArtistMethod())
