...
public class StreamingServiceImpl implements StreamingService {
    ...
    public StreamingServiceImpl(StreamingFileRepository streamingFileRepository) {
    ...
    @Override
    public Mono<ResponseEntity<StreamingResponseBody>> playVideo(String id, String rangeHeader) {
