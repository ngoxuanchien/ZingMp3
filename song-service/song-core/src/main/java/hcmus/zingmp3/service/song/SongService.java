...
public interface SongService {
    ...
    List<SongResponse> searchMySongs(String name, List<SongStatus> status, Pageable pageable);

    List<SongResponse> getAllMySongs(List<SongStatus> status, Pageable pageable);
}
