...
public class MediaStreamLoaderImpl implements MediaStreamLoader {
    ...
    @Override
    public ResponseEntity<StreamingResponseBody> playMediaFile(UUID id, String rangeHeader) {
        try
        {
            AudioFileDataDTO audioFileData = audioFileDataService.getAudioFileData(id);
            String filePathString = String.format(MEDIA_FILE_PATH, audioFileData.getPath(), audioFileData.getName());
            System.out.println(filePathString);
            ResponseEntity<StreamingResponseBody> retVal =
                    loadPartialMediaFile(filePathString, rangeHeader);
